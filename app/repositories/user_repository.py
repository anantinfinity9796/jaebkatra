...
class UserRepository(Repository):
    ...
    def create(self, db_pool, user: User):
    ...
    def update(self, db_pool, user:User):
...
"""
    ...
    def update_part(self, db_pool, user_id:UUID, update_dict:dict):
...
""".format(", ".join([f"{key} = {value}" for key,value in update_dict.items()]))
    ...
    def delete(self, db_pool, user_id: UUID):
    ...
    def append_to_wallets(self, db_pool, user_id:UUID, wallet_id: UUID):
...
"""
    ...
    def append_to_family_members(self, db_pool, user_id:UUID, family_member_id:UUID):
