...
class BudgetRepository(Repository):
    ...
    def get_all(self, db_cursor:Cursor) -> list:
        ...
        budgets_list = db_cursor.execute(list_budgets_query).fetchall()
        return budgets_list

    def get_one(self, db_cursor:Cursor, budget_id:UUID) -> dict:
        ...
        budget_data = db_cursor.execute(get_budget_query, {"budget_id":budget_id}).fetchone()
        return budget_data
        
    
    def create(self, db_cursor:Cursor, budget:Budget):
        ...
        db_cursor.execute(create_budget_query, budget_model_dump)
        return
    
    def update(self, db_cursor:Cursor, budget:Budget):
...
"""
        db_cursor.execute(update_budget_query, budget_model_dump)
        return

    def update_part(self):
        raise NotImplementedError
    
    def delete(self, db_cursor:Cursor, budget_id:UUID):
        ...
        db_cursor.execute(delete_budget_query, {"budget_id":budget_id})
        return