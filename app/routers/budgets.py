...
def list_budgets(budget_service: BudgetsService, db_conn: DbConn) -> list:
    try:
...
def get_budget_details(budget_id:UUID, budget_service: BudgetsService, db_conn: DbConn) -> dict:
    try:
